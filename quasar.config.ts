...
export default defineConfig((ctx) => {
  return {
    ...
    build: {
      ...
      // analyze: true,
      env: {
        VITE_API_URL: ctx.dev ? 'http://spendwise.localhost/api' : 'http://159.223.76.218:8080/api',
        // VITE_API_URL: 'http://159.223.76.218:8080/api',
      },
      // rawDefine: {}
    ...
    electron: {
      ...
      builder: {
        ...
        appId: 'spending-tracker-budget-app',
      },
    },
